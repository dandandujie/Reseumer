...
const EXPORT_TEMPLATES_DIR = path.join(ROOT, 'src/lib/export/templates');
const EXPORT_UTILS = path.join(ROOT, 'src/lib/export/utils.ts');
const EXPORT_BUILDERS = path.join(ROOT, 'src/lib/export/builders.ts');
